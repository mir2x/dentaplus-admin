    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          ...
          // Plain (non data-attribute-gated) width defaults so a consumer's `className`
          // can actually override them below — see cn()'s conflict resolution. The
          // data-[side=...] versions these replaced have higher CSS specificity than a
          // plain utility class, so a caller-supplied `sm:max-w-*`/`w-*` override was
          // silently losing to them no matter what was passed in.
