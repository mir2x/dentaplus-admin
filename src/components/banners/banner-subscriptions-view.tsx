  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-muted-foreground">
        Everyone who left their email in a banner&apos;s pop-up sign-up form on the storefront, with
        which banner prompted them. Use this list to follow up on interest generated by a specific
        promotion.
      </p>
